...
class TrainerDeepSVDD:
    ...
    def train(self,dataloader):
        net = network(in_channels=3*3, hidden_channels=64, out_channels=2,).to(self.device)
...
if __name__ == "__main__":
    ...
    train_dataset = dataset[2 * len(dataset) // 10:8 * len(dataset) // 10]
    ...
    deep_SVDD = TrainerDeepSVDD(device,10)
