...
def main(args):
    ...
    torch.save(deep_SVDD, "deep_SVDD_nlp.pt")
...
if __name__ == '__main__':
    ...
    #python main_svdd_nlp.py  --device cuda:2 --max_epoch 2  --num_hidden 64  --feat_drop 0.5 --mask_rate 1.0
    # python main_svdd_nlp.py  --device cuda:2 --max_epoch 2  --num_hidden 64  --feat_drop 0.8 --mask_rate 1.0