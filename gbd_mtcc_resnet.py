...
from models.gin_resnet import GINModule
...
if __name__ == "__main__":
    ...
    data_dir = "/home/jianghaoyu/Meta-Nerual-Trojan-Detection/resnet/cifar10/models/"
    ...
    datamodule = LightningDataset(train_dataset, val_dataset, test_dataset,
                                batch_size=2, drop_last=True, num_workers=1)#, num_workers=1
    # print(datamodule)

    #Load Model
    model = GINModule(in_channels=128, hidden_channels=64, out_channels=2,
                      )
    ...
    trainer = L.Trainer(precision=16,
                        ...
                        accelerator='gpu',
                        devices=devices,
                        max_epochs=5, log_every_n_steps=5,
