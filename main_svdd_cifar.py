...
def main(args):
    ...
    deep_SVDD = TrainerDeepSVDD(train_test_config['device'],10,model=model,dataloader=train_loader,pooler=pooler)
...
if __name__ == '__main__':
    ...
    #python main_svdd_cifar.py  --device cuda:0 --max_epoch 20 --num_hidden 32 