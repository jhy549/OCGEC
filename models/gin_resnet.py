...
from torch_geometric.nn import GIN, GCN,MLP, max_pool_neighbor_x,global_add_pool,global_mean_pool,global_max_pool
...
class GINModule(L.LightningModule):
    def __init__(self, in_channels: int, out_channels: int,
        ...
        self.classifier = MLP([hidden_channels, 512,128, out_channels],
