...
def eval(net, c, dataloader, device,pooler):
    ...
    # print('ACC score: {:.2f}'.format(accuracy_score(labels, scores)))
...
def main(args):
    ...
    test_dir = "/home/jianghaoyu/audio_outliers_1"
    # test_dir = "/home/jianghaoyu/audio_"
    # test_dir = "/home/jianghaoyu/Meta-Nerual-Trojan-Detection/shadow_model_ckpt/audio/outliers_wanet"
    ...
    train_dataset = dataset[7 * len(dataset) // 10:8 * len(dataset) // 10]
    ...
    model.load_state_dict(torch.load("GAEmodel_audio_1.pt"))
    ...
    # torch.save(deep_SVDD, "deep_SVDD_audio.pt")
    deep_SVDD = torch.load("deep_SVDD_audio.pt")
...
if __name__ == '__main__':
    ...
    #python main_svdd_audio.py  --device cuda:2 