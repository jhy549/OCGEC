...
from models.gin import GINModule
...
if __name__ == "__main__":
    ...
    datamodule = LightningDataset(train_dataset, val_dataset, test_dataset,
                                batch_size=8, drop_last=True, num_workers=0)#, num_workers=1
    # print(datamodule)

    #Load Model
    model = GINModule(in_channels=3*3, hidden_channels=64, out_channels=2,
                      )
