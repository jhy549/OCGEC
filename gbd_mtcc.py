...
if __name__ == "__main__":
    ...
    datamodule = LightningDataset(train_dataset, val_dataset, test_dataset,
                                batch_size=1, drop_last=True, num_workers=0)#, num_workers=1
    # print(datamodule)

    #Load Model
    model = GINModule(in_channels=512*513, hidden_channels=512, out_channels=2,
                      )
    ...
    trainer = L.Trainer(precision=16,
                        ...
                        accelerator='gpu',
                        devices=devices,
                        max_epochs=1, log_every_n_steps=5,
